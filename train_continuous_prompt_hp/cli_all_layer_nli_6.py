...
class Trainer(object):
    def __init__(self, args):
        ...
        #########load nq########
        from data_utils.dataset_all_layer import load_mli,MultiDataset
        #self.use_model = '/root/xsc/prompt/LAMA/out/template10_all_layerv2/mliv2/prompt_model/bert/search/bert_shared_template_(3, 3, 0, 0, 0)_fixed_seed_34/P1001/epoch_2_dev_f165.7876_dev_acc80.5399.ckpt'

        self.train_data = load_mli(args.train_data)[:40000]
        self.dev_data = load_mli(args.dev_data)
        self.test_data = load_mli(args.test_data)
