...
def construct_generation_args():
    ...
    parser.add_argument("--out_dir", type=str, default=join(abspath(dirname(__file__)), './out/template_ptunning_same_data_6/adhoc'))
    # MegatronLM 11B
...
class Trainer(object):
    def __init__(self, args):
        ...
        #########load nq########
        from data_utils.dataset_all_layer import load_adhoc_mq07,MultiDataset,load_adhoc_mq
        import joblib
        #self.use_model = '/root/xsc/prompt/LAMA/out/template_ptunning_same_data_6/adhoc/prompt_model/bert/search/bert_shared_template_(6, 6, 0, 0, 0)_fixed_seed_34/P1001/epoch_5_dev_f133.6847_dev_acc57.58.ckpt'
        #self.train_data,self.dev_data,self.test_data = load_adhoc_mq('/root/xsc/prompt/L2R_Data/original_mq2008/')
        # self.train_data,self.dev_data,self.test_data = load_adhoc_mq07('/root/xsc/prompt/L2R_Data/original_mq2007/')
        # joblib.dump(self.train_data,'/root/xsc/prompt/L2R_Data/original_mq2007/train')
        # joblib.dump(self.dev_data, '/root/xsc/prompt/L2R_Data/original_mq2007/dev')
        # joblib.dump(self.test_data, '/root/xsc/prompt/L2R_Data/original_mq2007/test')
        # print('adhoc is :')
        # print(len(self.train_data))
        self.train_data = joblib.load(args.train_data)
        self.dev_data = joblib.load(args.dev_data)
        self.test_data = joblib.load(args.test_data)
        print(len(self.train_data))
        random.shuffle(self.train_data)
        random.shuffle(self.dev_data)
        random.shuffle(self.test_data)
        #self.use_model = '/root/xsc/prompt/LAMA/out/template_ptunning_same_data_6/adhoc/prompt_model/bert/search/bert_shared_template_(6, 6, 0, 0, 0)_fixed_seed_34/P1001/epoch_5_dev_f167.1879_dev_acc66.98.ckpt'
        ...
        # model_CKPT = torch.load(self.use_model)
        # self.model.prompt_encoder.load_state_dict(model_CKPT['embedding'])
