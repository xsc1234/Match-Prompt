...
class Trainer(object):
    def __init__(self, args):
        ...
        #########load nq########
        from data_utils.dataset_all_layer import load_paws,load_msrp,load_csv,MultiDataset
        # self.use_model = '/root/xsc/prompt/LAMA/out/template10_all_layerv2/pi/prompt_model/bert/search/bert_shared_template_(3, 3, 0, 0, 0)_fixed_seed_34/P1001/epoch_12_dev_f171.397_dev_acc79.0362.ckpt'

        self.train_data_msrp = load_msrp('/root/xsc/prompt/data/PI/msrp/train.txt')
        self.dev_data_msrp = load_msrp('/root/xsc/prompt/data/PI/msrp/dev.txt')
        self.test_data_msrp = load_msrp('/root/xsc/prompt/data/PI/msrp/test.txt')

        self.train_data_quora = load_csv('/root/xsc/prompt/data/QUARA/train_.csv')[:35000]
        self.dev_data_quora = load_csv('/root/xsc/prompt/data/QUARA/dev.csv')
        self.test_data_quora = load_csv('/root/xsc/prompt/data/QUARA/test.csv')

        self.train_data = self.train_data_msrp + self.train_data_quora
        self.dev_data = self.dev_data_msrp + self.dev_data_quora
        self.test_data = self.test_data_msrp + self.test_data_quora
