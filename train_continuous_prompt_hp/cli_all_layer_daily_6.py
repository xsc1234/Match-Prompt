...
class Trainer(object):
    def __init__(self, args):
        ...
        #########load nq########
        from data_utils.dataset_all_layer import load_dailydialogue,MultiDataset
        import joblib
        # self.train_data = load_dailydialogue('/root/xsc/prompt/data/Dialogue/DailyDialog/dial.train')[:40000]
        # self.dev_data = load_dailydialogue('/root/xsc/prompt/data/Dialogue/DailyDialog/dial.valid')
        # self.test_data = load_dailydialogue('/root/xsc/prompt/data/Dialogue/DailyDialog/dial.test')
        # print(len(self.train_data))
        # joblib.dump(self.train_data,'/root/xsc/prompt/data/Dialogue/DailyDialog/train2')
        # joblib.dump(self.dev_data, '/root/xsc/prompt/data/Dialogue/DailyDialog/dev2')
        # joblib.dump(self.test_data, '/root/xsc/prompt/data/Dialogue/DailyDialog/test2')
